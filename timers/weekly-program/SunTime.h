...
class SunTime {
 public:
  ...
  static int64_t getLocalTime(int64_t utcTime = 0);
  static int64_t getUtcTime(int64_t localTime = 0);
  static void getTimeStruct(std::tm &timeStruct, int64_t utcTime = 0);
